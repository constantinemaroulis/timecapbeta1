import {
  axios_default
} from "./chunk-WELMVZTH.js";
import {
  require_react
} from "./chunk-DRWLMN53.js";
import {
  require_lib
} from "./chunk-JFYF4KWR.js";
import {
  __export,
  __toESM
...
function qe(r4, e, t, i = "brackets") {
  ...
  return r4 === "get" && Object.keys(t).length && (c.search = $.stringify(mergeWith($.parse(c.search, { ignoreQueryPrefix: true }), t, (l, h, I, w) => {
    h === void 0 && delete w[I];
...
var U = class r2 {
  ...
  mergeProps(e) {
    ...
    t.forEach((s) => {
      ...
      let o = e.props[s], u = n.get().props[s], d = (p, c) => Array.isArray(c) ? [...Array.isArray(p) ? p : [], ...c] : typeof c == "object" && c !== null ? Object.keys(c).reduce((l, h) => (l[h] = d(p ? p[h] : void 0, c[h]), l), { ...p }) : c;
      e.props[s] = d(u, o);
...
function Ie(r4, e, t) {
  ...
  function d(l, h = []) {
    l !== null && Object.keys(i).indexOf(l) > -1 && (i[l] = h), c();
  }
  function p() {
    let l = e(""), h = { ...l ? { title: `<title inertia="">${l}</title>` } : {} }, I = Object.values(i).reduce((w, R) => w.concat(R), []).reduce((w, R) => {
  ...
  return c(), { forceUpdate: c, createProvider: function() {
    let l = o();
    return { update: (h) => d(l, h), disconnect: () => u(l) };
  } };
}
var f = "nprogress";
var P;
...
var B2 = pe2;
function _2({ children: s, initialPage: t, initialComponent: a2, resolveComponent: p, titleCallback: i, onHeadUpdate: g2 }) {
  let [u, f2] = (0, import_react2.useState)({ component: a2 || null, page: t, key: null }), c = (0, import_react2.useMemo)(() => Ie(typeof window > "u", i || ((l) => l), g2 || (() => {
  })), []);
  if ((0, import_react2.useEffect)(() => {
    Wr.init({ initialPage: t, resolveComponent: p, swapComponent: async ({ component: l, page: e, preserveState: d }) => {
      f2((r4) => ({ component: l, page: e, key: d ? r4.key : Date.now() }));
  ...
  let m2 = s || (({ Component: l, props: e, key: d }) => {
    let r4 = (0, import_react2.createElement)(l, { key: d, ...e });
    return typeof l.layout == "function" ? l.layout(r4) : Array.isArray(l.layout) ? l.layout.concat(r4).reverse().reduce((h, F2) => (0, import_react2.createElement)(F2, { children: h, ...e })) : r4;
  });
...
_2.displayName = "Inertia";
async function ce2({ id: s = "app", resolve: t, setup: a2, title: p, progress: i = {}, page: g2, render: u }) {
  let f2 = typeof window > "u", c = f2 ? null : document.getElementById(s), m2 = g2 || JSON.parse(c.dataset.page), l = (r4) => Promise.resolve(t(r4)).then((h) => h.default || h), e = [], d = await Promise.all([l(m2.component), Wr.decryptHistory().catch(() => {
  })]).then(([r4]) => a2({ el: c, App: _2, props: { initialPage: m2, initialComponent: r4, resolveComponent: l, titleCallback: p, onHeadUpdate: f2 ? (h) => e = h : null } }));
  if (!f2 && i && Me(i), f2) {
    let r4 = await u((0, import_react.createElement)("div", { id: s, "data-page": JSON.stringify(m2) }, d));
    return { head: e, body: r4 };
  }
}
function q2() {
  let s = (0, import_react6.useContext)(B2);
  if (!s) throw new Error("usePage must be used within the Inertia component");
  return s;
}
var de2 = (s) => (s = new URL(s.href), s.hash = "", s);
var Ke2 = (s, t) => de2(s).href === de2(t).href;
var fe2 = ({ children: s, data: t, fallback: a2 }) => {
  if (!t) throw new Error("`<Deferred>` requires a `data` prop to be a string or array of strings");
  let [p, i] = (0, import_react5.useState)(false), g2 = q2().props, u = (0, import_react5.useMemo)(() => Array.isArray(t) ? t : [t], [t]);
  return (0, import_react5.useEffect)(() => {
    let f2 = me2.on("start", (c) => {
      let m2 = c.detail.visit.only.length > 0 || c.detail.visit.except.length > 0, l = c.detail.visit.only.find((e) => u.includes(e));
      Ke2(c.detail.visit.url, window.location) && (!m2 || l) && i(false);
    });
    return () => {
      f2();
    };
  }, []), (0, import_react5.useEffect)(() => {
    i(u.every((f2) => g2[f2] !== void 0));
  }, [g2, u]), p ? s : a2;
};
fe2.displayName = "InertiaDeferred";
var Be2 = fe2;
var je2 = function({ children: s, title: t }) {
  let a2 = (0, import_react7.useContext)(K2), p = (0, import_react7.useMemo)(() => a2.createProvider(), [a2]);
  ...
  function g2(e) {
    let d = Object.keys(e.props).reduce((r4, h) => {
      if (["head-key", "children", "dangerouslySetInnerHTML"].includes(h)) return r4;
      let F2 = e.props[h];
      return F2 === "" ? r4 + ` ${h}` : r4 + ` ${h}="${F2}"`;
    }, "");
    return `<${e.type}${d}>`;
  }
  function u(e) {
    return typeof e.props.children == "string" ? e.props.children : e.props.children.reduce((d, r4) => d + f2(r4), "");
  }
  function f2(e) {
    let d = g2(e);
    return e.props.children && (d += u(e)), e.props.dangerouslySetInnerHTML && (d += e.props.dangerouslySetInnerHTML.__html), i(e) || (d += `</${e.type}>`), d;
  }
  function c(e) {
  ...
  function l(e) {
    let d = import_react7.default.Children.toArray(e).filter((r4) => r4).map((r4) => m2(r4));
    return t && !d.find((r4) => r4.startsWith("<title")) && d.push(`<title inertia>${t}</title>`), d;
  }
  return p.update(l(s)), null;
};
var $e2 = je2;
var x2 = () => {
};
var he2 = (0, import_react8.forwardRef)(({ children: s, as: t = "a", data: a2 = {}, href: p, method: i = "get", preserveScroll: g2 = false, preserveState: u = null, replace: f2 = false, only: c = [], except: m2 = [], headers: l = {}, queryStringArrayFormat: e = "brackets", async: d = false, onClick: r4 = x2, onCancelToken: h = x2, onBefore: F2 = x2, onStart: I = x2, onProgress: E2 = x2, onFinish: Y2 = x2, onCancel: N2 = x2, onSuccess: z2 = x2, onError: M = x2, prefetch: v2 = false, cacheFor: b2 = 0, ...G2 }, X2) => {
  let [Z2, j2] = (0, import_react8.useState)(0), L2 = (0, import_react8.useRef)(null);
  t = t.toLowerCase(), i = typeof p == "object" ? p.method : i.toLowerCase();
  let [k2, ee2] = qe(i, typeof p == "object" ? p.url : p || "", a2, e), A2 = k2;
  a2 = ee2;
  let $2 = { data: a2, method: i, preserveScroll: g2, preserveState: u ?? i !== "get", replace: f2, only: c, except: m2, headers: l, async: d }, W2 = { ...$2, onCancelToken: h, onBefore: F2, onStart(o) {
    j2((w) => w + 1), I(o);
  }, onProgress: E2, onFinish(o) {
    j2((w) => w - 1), Y2(o);
  }, onCancel: N2, onSuccess: z2, onError: M }, H2 = () => {
    Wr.prefetch(A2, $2, { cacheFor: te2 });
  }, R = (0, import_react8.useMemo)(() => v2 === true ? ["hover"] : v2 === false ? [] : Array.isArray(v2) ? v2 : [v2], Array.isArray(v2) ? v2 : [v2]), te2 = (0, import_react8.useMemo)(() => b2 !== 0 ? b2 : R.length === 1 && R[0] === "click" ? 0 : 3e4, [b2, R]);
  (0, import_react8.useEffect)(() => () => {
    clearTimeout(L2.current);
  }, []), (0, import_react8.useEffect)(() => {
    R.includes("mount") && setTimeout(() => H2());
  }, R);
  let n2 = { onClick: (o) => {
    r4(o), Ne(o) && (o.preventDefault(), Wr.visit(A2, W2));
  } }, y2 = { onMouseEnter: () => {
    ...
    clearTimeout(L2.current);
  }, onClick: n2.onClick }, P2 = { onMouseDown: (o) => {
    Ne(o) && (o.preventDefault(), H2());
  }, onMouseUp: (o) => {
    o.preventDefault(), Wr.visit(A2, W2);
  }, onClick: (o) => {
    r4(o), Ne(o) && o.preventDefault();
  } };
  return i !== "get" && (t = "button"), (0, import_react8.createElement)(t, { ...G2, ...{ a: { href: A2 }, button: { type: "button" } }[t] || {}, ref: X2, ...R.includes("hover") ? y2 : R.includes("click") ? P2 : n2, "data-loading": Z2 > 0 ? "" : void 0 }, s);
});
he2.displayName = "InertiaLink";
var Ye2 = he2;
function V2(s, t) {
  let [a2, p] = (0, import_react10.useState)(() => {
    let i = Wr.restore(t);
    return i !== void 0 ? i : s;
  });
...
function ve2(s, t) {
  let a2 = (0, import_react9.useRef)(null), p = typeof s == "string" ? s : null, [i, g2] = (0, import_react9.useState)((typeof s == "string" ? t : s) || {}), u = (0, import_react9.useRef)(null), f2 = (0, import_react9.useRef)(null), [c, m2] = p ? V2(i, `${p}:data`) : (0, import_react9.useState)(i), [l, e] = p ? V2({}, `${p}:errors`) : (0, import_react9.useState)({}), [d, r4] = (0, import_react9.useState)(false), [h, F2] = (0, import_react9.useState)(false), [I, E2] = (0, import_react9.useState)(null), [Y2, N2] = (0, import_react9.useState)(false), [z2, M] = (0, import_react9.useState)(false), v2 = (0, import_react9.useRef)((n2) => n2);
  (0, import_react9.useEffect)(() => (a2.current = true, () => {
    a2.current = false;
  }), []);
  let b2 = (0, import_react9.useCallback)((...n2) => {
    let y2 = typeof n2[0] == "object", P2 = y2 ? n2[0].method : n2[0], C2 = y2 ? n2[0].url : n2[1], o = (y2 ? n2[1] : n2[2]) ?? {}, w = { ...o, onCancelToken: (S2) => {
      if (u.current = S2, o.onCancelToken) return o.onCancelToken(S2);
    }, onBefore: (S2) => {
      if (N2(false), M(false), clearTimeout(f2.current), o.onBefore) return o.onBefore(S2);
    }, onStart: (S2) => {
      if (F2(true), o.onStart) return o.onStart(S2);
    }, onProgress: (S2) => {
      if (E2(S2), o.onProgress) return o.onProgress(S2);
    }, onSuccess: (S2) => {
      if (a2.current && (F2(false), E2(null), e({}), r4(false), N2(true), M(true), g2(cloneDeep(c)), f2.current = setTimeout(() => {
        a2.current && M(false);
      }, 2e3)), o.onSuccess) return o.onSuccess(S2);
    }, onError: (S2) => {
      if (a2.current && (F2(false), E2(null), e(S2), r4(true)), o.onError) return o.onError(S2);
    }, onCancel: () => {
      if (a2.current && (F2(false), E2(null)), o.onCancel) return o.onCancel();
    }, onFinish: (S2) => {
      if (a2.current && (F2(false), E2(null)), u.current = null, o.onFinish) return o.onFinish(S2);
    } };
    P2 === "delete" ? Wr.delete(C2, { ...w, data: v2.current(c) }) : Wr[P2](C2, v2.current(c), w);
  }, [c, e, v2]), G2 = (0, import_react9.useCallback)((n2, y2) => {
    m2(typeof n2 == "string" ? (P2) => set(cloneDeep(P2), n2, y2) : typeof n2 == "function" ? (P2) => n2(P2) : n2);
  }, [m2]), X2 = (0, import_react9.useCallback)((n2, y2) => {
    g2(typeof n2 > "u" ? () => c : (P2) => typeof n2 == "string" ? set(cloneDeep(P2), n2, y2) : Object.assign(cloneDeep(P2), n2));
  }, [c, g2]), Z2 = (0, import_react9.useCallback)((...n2) => {
    n2.length === 0 ? m2(i) : m2((y2) => n2.filter((P2) => has(i, P2)).reduce((P2, C2) => set(P2, C2, get(i, C2)), { ...y2 }));
  }, [m2, i]), j2 = (0, import_react9.useCallback)((n2, y2) => {
    e((P2) => {
      let C2 = { ...P2, ...typeof n2 == "string" ? { [n2]: y2 } : n2 };
      return r4(Object.keys(C2).length > 0), C2;
    });
  }, [e, r4]), L2 = (0, import_react9.useCallback)((...n2) => {
    e((y2) => {
      let P2 = Object.keys(y2).reduce((C2, o) => ({ ...C2, ...n2.length > 0 && !n2.includes(o) ? { [o]: y2[o] } : {} }), {});
      return r4(Object.keys(P2).length > 0), P2;
    });
  }, [e, r4]), k2 = (n2) => (y2, P2) => {
    b2(n2, y2, P2);
  }, ee2 = (0, import_react9.useCallback)(k2("get"), [b2]), A2 = (0, import_react9.useCallback)(k2("post"), [b2]), $2 = (0, import_react9.useCallback)(k2("put"), [b2]), W2 = (0, import_react9.useCallback)(k2("patch"), [b2]), H2 = (0, import_react9.useCallback)(k2("delete"), [b2]), R = (0, import_react9.useCallback)(() => {
    u.current && u.current.cancel();
  }, []), te2 = (0, import_react9.useCallback)((n2) => {
    v2.current = n2;
  }, []);
  return { data: c, setData: G2, isDirty: !isEqual(c, i), errors: l, hasErrors: d, processing: h, progress: I, wasSuccessful: Y2, recentlySuccessful: z2, transform: te2, setDefaults: X2, reset: Z2, setError: j2, clearErrors: L2, submit: b2, get: ee2, post: A2, put: $2, patch: W2, delete: H2, cancel: R };
}
function Te2(s, t = {}, a2 = { keepAlive: false, autoStart: true }) {
  let p = (0, import_react11.useRef)(Wr.poll(s, t, { ...a2, autoStart: false }));
  return (0, import_react11.useEffect)(() => ((a2.autoStart ?? true) && p.current.start(), () => p.current.stop()), []), { stop: p.current.stop, start: p.current.start };
}
function be2(s = {}) {
  let t = typeof window > "u" ? null : Wr.getCached(window.location.pathname, s), a2 = typeof window > "u" ? null : Wr.getPrefetching(window.location.pathname, s), [p, i] = (0, import_react12.useState)((t == null ? void 0 : t.staleTimestamp) || null), [g2, u] = (0, import_react12.useState)(a2 !== null), [f2, c] = (0, import_react12.useState)(t !== null);
  return (0, import_react12.useEffect)(() => {
    let m2 = Wr.on("prefetching", (e) => {
      e.detail.visit.url.pathname === window.location.pathname && u(true);
    }), l = Wr.on("prefetched", (e) => {
      e.detail.visit.url.pathname === window.location.pathname && (u(false), c(true), i(e.detail.fetchedAt));
    });
    return () => {
      l(), m2();
    };
  }, []), { lastUpdatedAt: p, isPrefetching: g2, isPrefetched: f2, flush: () => Wr.flush(window.location.pathname, s) };
}
var Ce2 = ({ children: s, data: t, params: a2, buffer: p, as: i, always: g2, fallback: u }) => {
  g2 = g2 ?? false, i = i ?? "div", u = u ?? null;
  let [f2, c] = (0, import_react13.useState)(false), m2 = (0, import_react13.useRef)(false), l = (0, import_react13.useRef)(false), e = (0, import_react13.useRef)(null), d = (0, import_react13.useCallback)(() => {
    if (t) return { only: Array.isArray(t) ? t : [t] };
    if (!a2) throw new Error("You must provide either a `data` or `params` prop.");
    return a2;
  }, [a2, t]);
  return (0, import_react13.useEffect)(() => {
    if (!e.current) return;
    let r4 = new IntersectionObserver((h) => {
      if (!h[0].isIntersecting || (!g2 && m2.current && r4.disconnect(), l.current)) return;
      m2.current = true, l.current = true;
      let F2 = d();
      Wr.reload({ ...F2, onStart: (I) => {
        var _a;
        l.current = true, (_a = F2.onStart) == null ? void 0 : _a.call(F2, I);
      }, onFinish: (I) => {
        var _a;
        c(true), l.current = false, (_a = F2.onFinish) == null ? void 0 : _a.call(F2, I), g2 || r4.disconnect();
      } });
    }, { rootMargin: `${p || 0}px` });
    return r4.observe(e.current), () => {
      r4.disconnect();
    };
  }, [e, d, p]), g2 || !f2 ? (0, import_react13.createElement)(i, { props: null, ref: e }, f2 ? s : u) : f2 ? s : null;
};
Ce2.displayName = "InertiaWhenVisible";
var lt3 = Ce2;
var me2 = Wr;
export {
  Be2 as Deferred,
